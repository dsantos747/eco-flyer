...
export function Header() {
  return (
    <div className="w-full h-2 overflow-hidden flex place-content-center">
      ...
      <div className="fixed w-[110vw] h-12 md:h-20 bg-rose-50 z-20 p-0" style={{ "clip-path": "url(#cloud-clip-path)" }}></div>
      <div className="fixed w-[110vw] top-2 h-12 md:h-20 bg-rose-200 z-10 p-0" style={{ "clip-path": "url(#cloud-clip-path)" }}></div>
