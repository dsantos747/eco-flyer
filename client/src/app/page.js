...
export const locationImages = async (route_results) => {
  // Call API to get images for each object.keys, append image-related data to that object key
  // Try to find a FREE images API for this
};
