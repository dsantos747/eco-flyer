...
airports.columns = ["code", "lat", "lon"]

airports_output = airports.to_dict(orient="records")

with open("../data/airports.json", "w") as json_file:
    json.dump(airports_output, json_file)
